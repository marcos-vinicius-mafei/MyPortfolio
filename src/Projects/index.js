...
import kenzieGames from "../images/kenzieGames.png";
...
const Projects = [
  ...
  },
  {
    title: "KenzieHub",
    description:
      "A platform where users can register, update and remove their favorite technologies, skills and projects.",
  ...
  },
  {
    title: "nuKenzie",
    description:
      "A place where users can list their expenses and earnings and get a real-time calculation of their financial management.",
  ...
  },
  {
    title: "Kenzie Games",
    description:
      "The simulation of a gaming ecommerce where users can view, add and remove products from their cart.",
